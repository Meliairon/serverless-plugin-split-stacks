            ...
            if (Array.isArray(currentValue)) {
                ...
                if (Ref && Ref in this.resourcesById) {
                    ...
                    for (const match of matches) {
                        ...
                        if (item.includes(".")) {
                            const split_item = item.split(".", 1);
                            if (split_item[0] in this.resourcesById) {
                                references.push(new Reference(split_item[0], current))
                            }
                            continue;
                        }
                        references.push(new Reference(item, current));
                    }
                }
                else {
